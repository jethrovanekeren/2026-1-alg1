...
Seja $P < G$ um $p$-Sylow de um grupo $G$ de ordem $p^m \cdot b$ onde $b$ é coprimo a $p$. Se $P < Z(N_G(P))$ então a restrição da transferência $T : G \rightarrow P$ toma a forma $x \mapsto x^b$. Em particular $T : G \rightarrow P$ é sobrejetor, e seu núcleo é um subgrupo normal de $G$ complementar a $P$.
\end{thm}
...
\begin{proof}
Seja $G$ um grupo de ordem $N$, e seja $P < G$ um $p$-Sylow. Per ser de ordem $p$ temos $P \cong \Z/p$ e em particular $P$ é abeliano. Seja $N = N_G(P)$ e $Z = C_G(P)$. Como sempre, há um homomorfismo injetor $N / Z \rightarrow \Aut(P)$, o que neste caso é isomorfa a $\Z / (p-1)$, mas nenhum fator de $p-1$ divide a ordem de $N < G$, o que obriga $N = Z$.
